...
// AvailablePropertyAgentDetails available property agent details
//
// swagger:model AvailablePropertyAgentDetails
type AvailablePropertyAgentDetails struct {
...
// Validate validates this available property agent details
func (m *AvailablePropertyAgentDetails) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AvailablePropertyAgentDetails) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AvailablePropertyAgentDetails) UnmarshalBinary(b []byte) error {
	var res AvailablePropertyAgentDetails
